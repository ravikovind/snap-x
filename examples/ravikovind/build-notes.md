...
- `designs/qa-overlay.mjs`, `designs/qa-mobile.mjs` — the QA views.
...
- [x] No text in the danger zones (`qa-overlay.png`: avatar circle Ø230 at 160,396; x<200; x>1384; top/bottom edges). Text stays inside the safe area — the stats row measures y 299 → 337 (limit 346)
...
- [x] Mobile crop keeps name, title and stats fully visible — `qa-mobile-crop.png`
